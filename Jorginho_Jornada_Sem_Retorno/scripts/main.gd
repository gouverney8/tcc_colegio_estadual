...
@export_category("Alinhamento visual do jogador")
@export_range(-12.0,12.0,0.5) var player_platform_feet_offset_y := -1.0
@export_range(-12.0,16.0,0.5) var player_ground_feet_offset_y := 5.0
@export_range(440.0,560.0,1.0) var main_ground_center_threshold_y := 500.0
@export_category("Boss")
@export var boss_max_health := 24
@export var boss_phase_two_ratio := 0.5
@export_category("Portal")
@export_range(0.0,16.0,0.5) var portal_ground_overlap := 7.0
...
const PORTAL_V2_FRAMES: Array[Texture2D] = [
	preload("res://assets/portal_v2/frames/portal_01.png"),preload("res://assets/portal_v2/frames/portal_02.png"),
	preload("res://assets/portal_v2/frames/portal_03.png"),preload("res://assets/portal_v2/frames/portal_04.png"),
	preload("res://assets/portal_v2/frames/portal_05.png"),preload("res://assets/portal_v2/frames/portal_06.png"),
	preload("res://assets/portal_v2/frames/portal_07.png"),preload("res://assets/portal_v2/frames/portal_08.png"),
	preload("res://assets/portal_v2/frames/portal_09.png"),preload("res://assets/portal_v2/frames/portal_10.png"),
	preload("res://assets/portal_v2/frames/portal_11.png"),preload("res://assets/portal_v2/frames/portal_12.png"),
	preload("res://assets/portal_v2/frames/portal_13.png"),preload("res://assets/portal_v2/frames/portal_14.png"),
	preload("res://assets/portal_v2/frames/portal_15.png"),preload("res://assets/portal_v2/frames/portal_16.png")
]
const PORTAL_V2_EFFECTS: Array[Texture2D] = [
	preload("res://assets/portal_v2/effects/effect_01.png"),preload("res://assets/portal_v2/effects/effect_02.png"),
	preload("res://assets/portal_v2/effects/effect_03.png"),preload("res://assets/portal_v2/effects/effect_04.png"),
	preload("res://assets/portal_v2/effects/effect_05.png"),preload("res://assets/portal_v2/effects/effect_06.png"),
	preload("res://assets/portal_v2/effects/effect_07.png"),preload("res://assets/portal_v2/effects/effect_08.png"),
	preload("res://assets/portal_v2/effects/effect_09.png"),preload("res://assets/portal_v2/effects/effect_10.png"),
	preload("res://assets/portal_v2/effects/effect_11.png"),preload("res://assets/portal_v2/effects/effect_12.png"),
	preload("res://assets/portal_v2/effects/effect_13.png"),preload("res://assets/portal_v2/effects/effect_14.png"),
	preload("res://assets/portal_v2/effects/effect_15.png"),preload("res://assets/portal_v2/effects/effect_16.png"),
	preload("res://assets/portal_v2/effects/effect_17.png"),preload("res://assets/portal_v2/effects/effect_18.png")
]
const PORTAL_ART_SCALE := Vector2(1.15,1.15)
const PORTAL_EFFECT_BASE_SCALE := 1.13
const PORTAL_EFFECT_TARGET_VISIBLE_SIZE := Vector2(136.0,126.0)
# Os quatro últimos arquivos contraem o desenho até ele desaparecer. Como isso
# parecia uma mudança de escala do portal inteiro, o fechamento agora acontece
# por transparência depois do último quadro com silhueta estável.
const PORTAL_EFFECT_LAST_STABLE_FRAME := 13
const PORTAL_EFFECT_FADE_DURATION := 0.24
const PORTAL_EFFECT_USED_RECTS: Array[Rect2] = [
	Rect2(5,0,127,129),Rect2(4,2,130,127),Rect2(0,0,137,129),Rect2(3,0,138,128),
	Rect2(8,0,136,129),Rect2(0,0,129,129),Rect2(2,1,133,119),Rect2(0,0,140,129),
	Rect2(0,0,142,127),Rect2(0,0,145,128),Rect2(6,0,137,129),Rect2(0,0,137,128),
	Rect2(0,5,130,124),Rect2(4,5,133,124)
]
...
const DISPLAY_FONT: Font = preload("res://assets/fonte/Germania_One/GermaniaOne-Regular.ttf")
...
const TILESETS_V2_PATH := "res://assets/terrain/tilesets_v2/"
...
const HERO_JUMP_ATTACK_FRAMES: Array[Texture2D] = [
	preload("res://assets/hero/jorginho/jump_attack/frame_01.png"),
	preload("res://assets/hero/jorginho/jump_attack/frame_02.png"),
	preload("res://assets/hero/jorginho/jump_attack/frame_03.png"),
	preload("res://assets/hero/jorginho/jump_attack/frame_04.png"),
	preload("res://assets/hero/jorginho/jump_attack/frame_05.png"),
]
const HERO_JUMP_ATTACK_SCALE := 0.22
const HERO_JUMP_ATTACK_BOTTOM_Y := 33.0
const HERO_JUMP_ATTACK_X_OFFSETS := [0.0, 8.0, 15.0, 2.0, -5.0]
const HERO_JUMP_ATTACK_ALPHA_BOTTOMS := [427.0, 516.0, 415.0, 387.0, 296.0]
...
const ULTIMATE_POSE_SCALE := HERO_SPRITE_SCALE
...
const ATTACK_FX_V2 := {
	"bramble_roots":preload("res://assets/combat/enemy_attacks_v2/bramble/bramble_armadilha_raizes.png"),
	"bramble_whip":preload("res://assets/combat/enemy_attacks_v2/bramble/bramble_chicote_espinhos.png"),
	"mushroom_spores":preload("res://assets/combat/enemy_attacks_v2/cogumelo/cogumelo_ataque_esporos.png"),
	"mushroom_impact":preload("res://assets/combat/enemy_attacks_v2/cogumelo/cogumelo_impacto_chapeu.png"),
	"spore_explosion":preload("res://assets/combat/enemy_attacks_v2/esporo/esporo_explosao_venenosa.png"),
	"spore_projectile":preload("res://assets/combat/enemy_attacks_v2/esporo/esporo_projetil_toxico.png"),
	"skeleton_slash":preload("res://assets/combat/enemy_attacks_v2/esqueleto/esqueleto_corte_espada.png"),
	"skeleton_bone":preload("res://assets/combat/enemy_attacks_v2/esqueleto/esqueleto_lancamento_osso.png"),
	"sentinel_shot":preload("res://assets/combat/enemy_attacks_v2/sentinela/sentinela_disparo_magico.png"),
	"sentinel_thrust":preload("res://assets/combat/enemy_attacks_v2/sentinela/sentinela_estocada_energetica.png"),
	"flying_projectile":preload("res://assets/combat/enemy_attacks_v2/voador/voador_projetil_floral.png"),
	"flying_trail":preload("res://assets/combat/enemy_attacks_v2/voador/voador_rastro_mergulho.png")
}
...
const CUTSCENE_DIALOGUE_FRAME: Texture2D = preload("res://assets/ui/cutscene_v2/01_janelas_dialogo/dialogo_grande.png")
const CUTSCENE_NAMEPLATE: Texture2D = preload("res://assets/ui/cutscene_v2/02_caixas/plaqueta_nome.png")
const CUTSCENE_PORTRAIT_FRAME: Texture2D = preload("res://assets/ui/cutscene_v2/03_molduras/moldura_retrato.png")
const CUTSCENE_TOP_BAR: Texture2D = preload("res://assets/ui/cutscene_v2/07_barras_cinematicas/barra_superior_ornamentada.png")
const CUTSCENE_BOTTOM_BAR: Texture2D = preload("res://assets/ui/cutscene_v2/07_barras_cinematicas/barra_inferior_ornamentada.png")
const CUTSCENE_STORY_FRAME_PATHS := [
	"res://assets/cutscene/story_frames/part_01.png","res://assets/cutscene/story_frames/part_02.png",
	"res://assets/cutscene/story_frames/part_03.png","res://assets/cutscene/story_frames/part_04.png",
	"res://assets/cutscene/story_frames/part_05.png","res://assets/cutscene/story_frames/part_06.png",
	"res://assets/cutscene/story_frames/part_07.png","res://assets/cutscene/story_frames/part_08.png",
	"res://assets/cutscene/story_frames/part_09.png","res://assets/cutscene/story_frames/part_10.png",
	"res://assets/cutscene/story_frames/part_11.png","res://assets/cutscene/story_frames/part_12.png",
	"res://assets/cutscene/story_frames/part_13.png","res://assets/cutscene/story_frames/part_14.png",
	"res://assets/cutscene/story_frames/part_15.png"
]
const CUTSCENE_STORY_LINES := [
	"Jorginho deixa a vila para trás, em busca de algo maior.",
	"Ele segue por um antigo caminho, cada vez mais fundo na floresta.",
	"Luzes estranhas surgem à sua frente. Jorginho para e observa.",
	"No meio da clareira, um antigo santuário repousa em silêncio.",
	"Jorginho sobe os primeiros degraus, sem saber o que despertou ali.",
	"As runas se acendem em silêncio. O ar ao redor parece diferente.",
	"Uma energia antiga percorre as pedras, como se o santuário despertasse.",
	"Do vazio, um redemoinho surge. Jorginho mal consegue acreditar.",
	"O portal enfim desperta. A floresta inteira reage ao chamado.",
	"O brilho corta a escuridão. Jorginho tenta enxergar entre as rajadas.",
	"A força do portal o puxa sem aviso. Cada passo para trás parece inútil.",
	"Num instante, tudo sai do controle. Jorginho é engolido pelo redemoinho.",
	"Atravessando o desconhecido, Jorginho sente o mundo desaparecer.",
	"Quando tudo se acalma, um novo mundo se revela diante dele.",
	"No Vale das Águas começa sua verdadeira jornada. Nada será como antes."
]
const MAIN_MENU_SCENE: PackedScene = preload("res://scenes/ui/main_menu.tscn")
const PHASE_SELECT_SCENE: PackedScene = preload("res://scenes/ui/phase_select.tscn")
const SETTINGS_FRAME_SCENE: PackedScene = preload("res://scenes/ui/settings_frame.tscn")
const CREDITS_FRAME_SCENE: PackedScene = preload("res://scenes/ui/credits_frame.tscn")
const LABELED_ACTION_BUTTON_SCENE: PackedScene = preload("res://scenes/ui/labeled_action_button.tscn")
const DIFFICULTY_SELECTION_SCENE: PackedScene = preload("res://scenes/ui/difficulty_selection_v2.tscn")
const GAME_HUD_SCENE: PackedScene = preload("res://scenes/ui/game_hud.tscn")
const ENEMY_ATTACK_FX_V2_SCENE: PackedScene = preload("res://scenes/combat/enemy_attack_fx_v2.tscn")
const WORLD_TUTORIAL_SPEECH_SCENE: PackedScene = preload("res://scenes/ui/world_tutorial_speech.tscn")
const HUD_HEART_FULL: Texture2D = preload("res://assets/ui/hud_v2/02_coracoes/cheio.png")
const HUD_HEART_HALF: Texture2D = preload("res://assets/ui/hud_v2/02_coracoes/metade.png")
const HUD_HEART_EMPTY: Texture2D = preload("res://assets/ui/hud_v2/02_coracoes/vazio.png")
const LEVEL_SCENES := [
...
const PARALLAX_SCENES := [
	"res://scenes/parallax/parallax_tropical.tscn",
	"res://scenes/parallax/parallax_industrial.tscn",
	"res://scenes/parallax/parallax_ruins_night.tscn"
]
...
var boss_health_value_label: Label
var boss_health_host: Control
var boss_health_clip: Control
var boss_health_liquid: ColorRect
var boss_health_shine: ColorRect
var boss_health_bg_style: StyleBoxFlat
...
var hero_animation_frame_sizes := {}
...
func _ready() -> void:
	...
	hero_textures = {
		...
		"jump_attack": HERO_JUMP_ATTACK_FRAMES[0],
		"hurt": HERO_HURT,
...
func hero_frame_rect(animation_name: String, frame_index: int) -> Rect2:
	...
	var frame_size: Vector2i=hero_animation_frame_sizes.get(animation_name,Vector2i(HERO_FRAME_SIZE,HERO_FRAME_SIZE))
	if coordinates.is_empty(): return Rect2(0,0,frame_size.x,frame_size.y)
	var coordinate: Vector2i = coordinates[posmod(frame_index,coordinates.size())]
	return Rect2(coordinate.x*frame_size.x,coordinate.y*frame_size.y,frame_size.x,frame_size.y)
...
func clear_screen() -> void:
	...
	boss_hud_bar = null
	boss_hud_name = null
	boss_health_value_label = null
	boss_health_host = null
	boss_health_clip = null
	boss_health_liquid = null
	boss_health_shine = null
	boss_health_bg_style = null
...
func make_labeled_action_button(text: String, width := 280, height := 68) -> TextureButton:
	var button := LABELED_ACTION_BUTTON_SCENE.instantiate() as TextureButton
	button.custom_minimum_size=Vector2(width,height)
	button.set("caption",text)
	var adaptive_size := 23
	if text.length() >= 15: adaptive_size=19
	elif text.length() >= 12: adaptive_size=21
	button.set("caption_size",adaptive_size)
	button.mouse_entered.connect(func(): play_ui_sound("kenney/ui_hover.ogg",-20.0,1.02))
	button.focus_entered.connect(func(): play_ui_sound("kenney/ui_hover.ogg",-20.0,1.02))
	button.pressed.connect(func(): play_ui_sound("kenney/ui_confirm.ogg",-14.0))
	return button
...
func show_menu() -> void:
	...
	menu_layer.name = "MenuPrincipal"
	add_child(menu_layer)
	var view := MAIN_MENU_SCENE.instantiate()
	menu_layer.add_child(view)
	view.configure(has_save())
	view.play_requested.connect(func(): pending_stage_selection=-1; show_difficulty_selection())
	view.continue_requested.connect(func(): call_deferred("continue_game"))
	view.phase_select_requested.connect(show_phase_selection)
	view.settings_requested.connect(show_settings)
	view.credits_requested.connect(show_credits)
	view.quit_requested.connect(quit_game)
	view.ui_hovered.connect(func(): play_ui_sound("kenney/ui_hover.ogg",-20.0,1.02))
	view.ui_accepted.connect(func(): play_ui_sound("kenney/ui_confirm.ogg",-14.0))

func show_phase_selection() -> void:
	state = "menu"
	get_tree().paused = false
	clear_screen()
	load_menu_progress()
	menu_layer = CanvasLayer.new()
	menu_layer.name = "SelecaoDeFases"
	add_child(menu_layer)
	var view := PHASE_SELECT_SCENE.instantiate()
	menu_layer.add_child(view)
	view.configure(highest_unlocked_level,level,highest_completed_level)
	view.back_requested.connect(func(): call_deferred("show_menu"))
	view.stage_requested.connect(_choose_stage_from_menu)
	view.ui_hovered.connect(func(): play_ui_sound("kenney/ui_hover.ogg",-20.0,1.02))
	view.ui_accepted.connect(func(): play_ui_sound("kenney/ui_confirm.ogg",-14.0))

func _choose_stage_from_menu(stage_index: int) -> void:
	pending_stage_selection = clampi(stage_index,0,highest_unlocked_level)
...
func show_settings() -> void:
	var modal := SETTINGS_FRAME_SCENE.instantiate()
	modal.name = "Modal"
	menu_layer.add_child(modal)
	var box := modal.get_node("%ContentSlot") as VBoxContainer
	var tabs := TabContainer.new()
	tabs.custom_minimum_size = Vector2(612,398)
	tabs.add_theme_font_size_override("font_size",15)
	tabs.add_theme_color_override("font_selected_color",Color("#ffe37a"))
	tabs.add_theme_color_override("font_unselected_color",Color("#d8c69c"))
	tabs.add_theme_stylebox_override("panel",settings_tab_style(Color(0.025,0.045,0.030,0.55)))
	tabs.add_theme_stylebox_override("tab_selected",settings_tab_style(Color("#6b471f"),Color("#f1c84d")))
	tabs.add_theme_stylebox_override("tab_unselected",settings_tab_style(Color("#34271e"),Color("#758b55")))
	tabs.tab_changed.connect(func(_index): play_ui_sound("kenney/ui_toggle.ogg",-18.0))
	box.add_child(tabs)
	var audio := VBoxContainer.new()
	audio.name = "ÁUDIO"
	audio.add_theme_constant_override("separation",18)
	tabs.add_child(audio)
	audio.add_child(make_section_label("VOLUMES DA JORNADA"))
	audio.add_child(make_volume_control("MÚSICA",music_volume,func(value): music_volume=float(value); AudioManager.set_music_volume(music_volume),"MusicVolumeSlider"))
	audio.add_child(make_volume_control("EFEITOS",sfx_volume,func(value): sfx_volume=float(value); AudioManager.set_sfx_volume(sfx_volume),"SfxVolumeSlider"))
	var audio_hint := Label.new(); audio_hint.text="As alterações de volume são ouvidas imediatamente."; audio_hint.horizontal_alignment=HORIZONTAL_ALIGNMENT_CENTER; audio_hint.add_theme_color_override("font_color",Color("#bde5a0")); audio.add_child(audio_hint)
	var video := VBoxContainer.new()
	video.name = "VÍDEO"
	video.add_theme_constant_override("separation",15)
	tabs.add_child(video)
	video.add_child(make_section_label("EXIBIÇÃO"))
	...
	mode.name="DisplayModeOption"
	style_settings_button(mode)
	...
	mode_row.add_child(mode); video.add_child(mode_row)
	...
	resolution.name="ResolutionOption"
	style_settings_button(resolution)
	...
	resolution_row.add_child(resolution); video.add_child(resolution_row)
	...
	scale_option.name="VisualScaleOption"
	style_settings_button(scale_option)
	...
	for action in actions:
		...
		var key_button := Button.new(); key_button.text=get_action_key(action); key_button.custom_minimum_size=Vector2(220,32); style_settings_button(key_button); key_button.pressed.connect(begin_remap.bind(action,key_button)); controls_grid.add_child(key_button); remap_buttons[action]=key_button
	var gameplay := VBoxContainer.new()
	gameplay.name = "JOGABILIDADE"
	gameplay.add_theme_constant_override("separation",20)
	tabs.add_child(gameplay)
	gameplay.add_child(make_section_label("EFEITOS E CONFORTO"))
	var shake := CheckButton.new(); shake.text="TREMOR DE CÂMERA"; shake.button_pressed=screen_shake; style_settings_toggle(shake)
	...
	gameplay.add_child(shake)
	gameplay.add_child(make_volume_control("INTENSIDADE DOS FLASHES",flash_intensity,func(value): flash_intensity=float(value),"FlashIntensitySlider"))
	var gameplay_hint := Label.new(); gameplay_hint.text="Reduza os flashes ou desligue o tremor para uma experiência mais confortável."; gameplay_hint.autowrap_mode=TextServer.AUTOWRAP_WORD_SMART; gameplay_hint.horizontal_alignment=HORIZONTAL_ALIGNMENT_CENTER; gameplay_hint.add_theme_color_override("font_color",Color("#bde5a0")); gameplay.add_child(gameplay_hint)
	settings_status_label = modal.get_node("%SettingsStatus") as Label
	var apply := modal.get_node("%ApplyButton") as TextureButton
	var defaults := modal.get_node("%RestoreButton") as TextureButton
	var back := modal.get_node("%BackButton") as TextureButton
	for action_button in [apply,defaults,back]:
		action_button.mouse_entered.connect(func(): play_ui_sound("kenney/ui_hover.ogg",-20.0))
		action_button.focus_entered.connect(func(): play_ui_sound("kenney/ui_hover.ogg",-20.0))
		action_button.pressed.connect(func(): play_ui_sound("kenney/ui_confirm.ogg",-14.0))
	apply.pressed.connect(func(): save_settings(); settings_status_label.text="ALTERAÇÕES APLICADAS.")
	defaults.pressed.connect(restore_default_settings)
	back.pressed.connect(func(): save_settings(); close_menu_modal())
	call_deferred("focus_first_button",modal)
...
func settings_tab_style(background: Color, border := Color("#709457")) -> StyleBoxFlat:
	var style := StyleBoxFlat.new()
...
func style_settings_button(button: Button) -> void:
	button.add_theme_font_size_override("font_size",15)
	button.add_theme_color_override("font_color",Color("#ffe6a1"))
	button.add_theme_color_override("font_hover_color",Color.WHITE)
	button.add_theme_stylebox_override("normal",settings_tab_style(Color("#3d2b1d"),Color("#789456")))
	button.add_theme_stylebox_override("hover",settings_tab_style(Color("#67431d"),Color("#f0c84e")))
	button.add_theme_stylebox_override("pressed",settings_tab_style(Color("#81551f"),Color("#fff09a")))

func style_settings_toggle(toggle: CheckButton) -> void:
	toggle.add_theme_font_size_override("font_size",16)
	toggle.add_theme_color_override("font_color",Color("#f4e6bd"))
	toggle.add_theme_icon_override("unchecked",load("res://assets/ui/componentes/controles_configuracoes/toggles/desligado.png"))
	toggle.add_theme_icon_override("checked",load("res://assets/ui/componentes/controles_configuracoes/toggles/ligado.png"))

func make_volume_control(label_text: String, value: float, callback: Callable, slider_name := "") -> HBoxContainer:
	var row := HBoxContainer.new(); var label := Label.new(); label.text=label_text; label.custom_minimum_size.x=180; label.add_theme_color_override("font_color",Color("#f4e6bd")); row.add_child(label)
	var slider := HSlider.new(); slider.min_value=0; slider.max_value=1; slider.step=0.05; slider.value=value; slider.custom_minimum_size=Vector2(380,34)
	if not slider_name.is_empty(): slider.name=slider_name
	var empty_style := ui_texture_style(load("res://assets/ui/componentes/controles_configuracoes/sliders/trilha_vazia.png"),Color.WHITE,26,10)
	var filled_style := ui_texture_style(load("res://assets/ui/componentes/controles_configuracoes/sliders/trilha_preenchida.png"),Color.WHITE,26,10)
	...
	slider.add_theme_icon_override("grabber",load("res://assets/ui/componentes/controles_configuracoes/sliders/controle_normal.png"))
	slider.add_theme_icon_override("grabber_highlight",load("res://assets/ui/componentes/controles_configuracoes/sliders/controle_hover.png"))
	slider.value_changed.connect(callback); row.add_child(slider); return row
...
func restore_default_settings() -> void:
	...
	windowed_resolution=BASE_RESOLUTION
	visual_scale=1.0
	...
	if not embedded_run:
		DisplayServer.window_set_mode(DisplayServer.WINDOW_MODE_WINDOWED)
		DisplayServer.window_set_size(windowed_resolution)
		call_deferred("center_game_window")
	apply_content_scale()
	restore_default_controls(false)
	var modal := menu_layer.get_node_or_null("Modal")
	if is_instance_valid(modal):
		var music_slider := modal.find_child("MusicVolumeSlider",true,false) as HSlider
		var sfx_slider := modal.find_child("SfxVolumeSlider",true,false) as HSlider
		var flash_slider := modal.find_child("FlashIntensitySlider",true,false) as HSlider
		var shake_toggle := modal.find_child("ScreenShakeToggle",true,false) as CheckButton
		var mode_option := modal.find_child("DisplayModeOption",true,false) as OptionButton
		var resolution_option := modal.find_child("ResolutionOption",true,false) as OptionButton
		var scale_option := modal.find_child("VisualScaleOption",true,false) as OptionButton
		if music_slider: music_slider.value=music_volume
		if sfx_slider: sfx_slider.value=sfx_volume
		if flash_slider: flash_slider.value=flash_intensity
		if shake_toggle: shake_toggle.button_pressed=screen_shake
		if mode_option: mode_option.select(0)
		if resolution_option: resolution_option.select(DISPLAY_RESOLUTIONS.find(BASE_RESOLUTION))
		if scale_option: scale_option.select(VISUAL_SCALES.find(1.0))
	save_settings()
	if is_instance_valid(settings_status_label): settings_status_label.text="TODAS AS CONFIGURAÇÕES FORAM RESTAURADAS."

func restore_default_controls(play_feedback := true) -> void:
	...
	if play_feedback: play_ui_sound("ui_confirm_v10.wav",-12.0,1.08)
...
func start_selected_level(stage_index: int) -> void:
	level = clampi(stage_index,0,highest_unlocked_level)
	pending_stage_selection = -1
	max_health = maxi(max_health,player_max_health)
...
func show_origin_cutscene() -> void:
	...
	get_tree().paused=false
	clear_screen()
	play_music("Light Ambience 2.mp3",-9.0)
	var layer:=CanvasLayer.new()
	layer.name="OriginCutscene"
	add_child(layer)
	var black:=ColorRect.new()
	black.name="FundoPreto"
	black.color=Color("#020609")
	black.set_anchors_and_offsets_preset(Control.PRESET_FULL_RECT)
	black.mouse_filter=Control.MOUSE_FILTER_IGNORE
	layer.add_child(black)
	var first_texture:=load(CUTSCENE_STORY_FRAME_PATHS[0]) as Texture2D
	var backdrop:=TextureRect.new()
	backdrop.name="FundoIlustrado"
	backdrop.set_anchors_and_offsets_preset(Control.PRESET_FULL_RECT)
	backdrop.texture=first_texture
	backdrop.expand_mode=TextureRect.EXPAND_IGNORE_SIZE
	backdrop.stretch_mode=TextureRect.STRETCH_KEEP_ASPECT_COVERED
	backdrop.modulate=Color(0.22,0.34,0.42,0.42)
	backdrop.mouse_filter=Control.MOUSE_FILTER_IGNORE
	layer.add_child(backdrop)
	var shade:=ColorRect.new()
	shade.color=Color(0.005,0.012,0.02,0.38)
	shade.set_anchors_and_offsets_preset(Control.PRESET_FULL_RECT)
	shade.mouse_filter=Control.MOUSE_FILTER_IGNORE
	layer.add_child(shade)
	var art_view:=Control.new()
	art_view.name="QuadroIlustrado"
	art_view.position=Vector2(216,10)
	art_view.size=Vector2(720,515)
	art_view.clip_contents=true
	art_view.mouse_filter=Control.MOUSE_FILTER_IGNORE
	layer.add_child(art_view)
	var art_a:=make_cutscene_story_art(first_texture,art_view.size)
	art_a.name="ImagemAtual"
	art_view.add_child(art_a)
	var art_b:=make_cutscene_story_art(first_texture,art_view.size)
	art_b.name="ProximaImagem"
	art_b.modulate.a=0.0
	art_view.add_child(art_b)
	var border:=Panel.new()
	border.name="MolduraDoQuadro"
	border.position=art_view.position-Vector2(4,4)
	border.size=art_view.size+Vector2(8,8)
	border.mouse_filter=Control.MOUSE_FILTER_IGNORE
	var border_style:=StyleBoxFlat.new()
	border_style.bg_color=Color(0.005,0.012,0.018,0.18)
	border_style.border_color=Color("#6594c8")
	...
	var dialogue:=NinePatchRect.new()
	dialogue.name="JanelaDialogoNova"
	dialogue.position=Vector2(102,472)
	dialogue.size=Vector2(948,168)
	dialogue.texture=CUTSCENE_DIALOGUE_FRAME
	dialogue.patch_margin_left=70
	dialogue.patch_margin_top=52
	dialogue.patch_margin_right=70
	dialogue.patch_margin_bottom=46
	dialogue.mouse_filter=Control.MOUSE_FILTER_IGNORE
	dialogue.z_index=20
	layer.add_child(dialogue)
	var speaker:=Label.new()
	speaker.name="Speaker"
	speaker.position=Vector2(188,493)
	speaker.size=Vector2(230,28)
	speaker.text="NARRADOR"
	speaker.add_theme_font_override("font",DISPLAY_FONT)
	speaker.add_theme_font_size_override("font_size",14)
	speaker.add_theme_color_override("font_color",Color("#ffe4a0"))
	speaker.add_theme_color_override("font_outline_color",Color(0.02,0.01,0.005,0.95))
	speaker.add_theme_constant_override("outline_size",3)
	speaker.z_index=23
	layer.add_child(speaker)
	var story:=Label.new()
	story.name="StoryText"
	story.position=Vector2(210,521)
	story.size=Vector2(760,70)
	story.vertical_alignment=VERTICAL_ALIGNMENT_CENTER
	story.autowrap_mode=TextServer.AUTOWRAP_WORD_SMART
	story.add_theme_font_size_override("font_size",19)
	story.add_theme_color_override("font_color",Color("#fff4d7"))
	story.add_theme_color_override("font_outline_color",Color(0.01,0.01,0.015,0.98))
	story.add_theme_constant_override("outline_size",3)
	story.z_index=23
	layer.add_child(story)
	var prompt:=Label.new()
	prompt.name="AdvancePrompt"
	prompt.position=Vector2(720,601)
	prompt.size=Vector2(254,24)
	prompt.horizontal_alignment=HORIZONTAL_ALIGNMENT_RIGHT
	prompt.add_theme_font_size_override("font_size",11)
	prompt.add_theme_color_override("font_color",Color("#9be8cf"))
	prompt.z_index=23
	layer.add_child(prompt)
	var skip:=make_labeled_action_button("PULAR PRÓLOGO",220,50)
	skip.name="SkipButton"
	skip.position=Vector2(914,12)
	skip.size=Vector2(220,50)
	skip.set("caption_size",15)
	skip.z_index=30
	layer.add_child(skip)
	skip.pressed.connect(func(): call_deferred("finish_origin_cutscene",token))
	create_cutscene_story_motes(layer)
	var opening:=ColorRect.new()
	opening.color=Color(0,0,0,1)
	opening.set_anchors_and_offsets_preset(Control.PRESET_FULL_RECT)
	opening.mouse_filter=Control.MOUSE_FILTER_IGNORE
	opening.z_index=40
	layer.add_child(opening)
	var open_tween:=create_tween().bind_node(opening)
	open_tween.tween_property(opening,"color:a",0.0,0.65)
	open_tween.tween_callback(opening.queue_free)
	var current_art: TextureRect=art_a
	var next_art: TextureRect=art_b
	for index in CUTSCENE_STORY_FRAME_PATHS.size():
		if token!=cutscene_token or not is_instance_valid(layer): return
		var frame_texture:=load(CUTSCENE_STORY_FRAME_PATHS[index]) as Texture2D
		if index>0:
			next_art.texture=frame_texture
			next_art.modulate=Color(1,1,1,0)
			next_art.scale=Vector2.ONE
			next_art.position=Vector2.ZERO
			var transition:=create_tween().bind_node(layer)
			transition.tween_property(current_art,"modulate:a",0.0,0.42)
			transition.parallel().tween_property(next_art,"modulate:a",1.0,0.42)
			await transition.finished
			if token!=cutscene_token: return
			var swap_art:=current_art
			current_art=next_art
			next_art=swap_art
			backdrop.texture=frame_texture
		await cutscene_rpg_line(story,speaker,prompt,String(CUTSCENE_STORY_LINES[index]),"NARRADOR",2.4,token)
	var whiteout:=ColorRect.new()
	whiteout.color=Color(0.70,0.94,1.0,0.0)
	...
	finish.tween_property(whiteout,"color:a",1.0,0.48)
	await finish.finished
	finish_origin_cutscene(token)

func make_cutscene_story_art(texture: Texture2D, target_size: Vector2) -> TextureRect:
	var art:=TextureRect.new()
	art.texture=texture
	art.size=target_size
	art.pivot_offset=target_size*0.5
	art.expand_mode=TextureRect.EXPAND_IGNORE_SIZE
	art.stretch_mode=TextureRect.STRETCH_KEEP_ASPECT_CENTERED
	art.mouse_filter=Control.MOUSE_FILTER_IGNORE
	return art

func create_cutscene_story_motes(layer: CanvasLayer) -> void:
	for index in 12:
		var mote:=ColorRect.new()
		var mote_size:=2.0+float(index%3)
		mote.size=Vector2(mote_size,mote_size)
		mote.position=Vector2(70+index*93,90+(index*71)%330)
		mote.color=Color("#9be8ff") if index%3==0 else Color("#ffe477")
		mote.modulate.a=0.18+float(index%4)*0.07
		mote.mouse_filter=Control.MOUSE_FILTER_IGNORE
		mote.z_index=12
		layer.add_child(mote)
		var float_tween:=create_tween().bind_node(mote).set_loops()
		float_tween.tween_property(mote,"position:y",mote.position.y-12.0,1.5+float(index%4)*0.25).set_trans(Tween.TRANS_SINE)
		float_tween.parallel().tween_property(mote,"modulate:a",0.65,0.8)
		float_tween.tween_property(mote,"position:y",mote.position.y,1.5+float(index%4)*0.25).set_trans(Tween.TRANS_SINE)
		float_tween.parallel().tween_property(mote,"modulate:a",0.18,0.8)

func show_origin_cutscene_legacy() -> void:
	cutscene_token += 1
	var token := cutscene_token
	cutscene_advance_requested = false
	state = "cutscene"
	...
	top_back.color=Color(0.01,0.018,0.018,0.90)
	top_back.size=Vector2(VIEW.x,54)
	top_back.mouse_filter=Control.MOUSE_FILTER_IGNORE
	layer.add_child(top_back)
	var top:=TextureRect.new()
	top.name="BarraCinematicaSuperior"
	top.position=Vector2(0,-8)
	top.size=Vector2(VIEW.x,76)
	top.texture=CUTSCENE_TOP_BAR
	...
	bottom.name="BarraCinematicaInferior"
	bottom.position=Vector2(0,575)
	bottom.size=Vector2(VIEW.x,73)
	bottom.texture=CUTSCENE_BOTTOM_BAR
	...
	var dialogue_panel:=NinePatchRect.new()
	dialogue_panel.name="JanelaDialogoNova"
	dialogue_panel.position=Vector2(68,468)
	dialogue_panel.size=Vector2(1048,174)
	dialogue_panel.texture=CUTSCENE_DIALOGUE_FRAME
	dialogue_panel.patch_margin_left=70
	dialogue_panel.patch_margin_top=52
	dialogue_panel.patch_margin_right=70
	dialogue_panel.patch_margin_bottom=46
	dialogue_panel.mouse_filter=Control.MOUSE_FILTER_IGNORE
	dialogue_panel.z_index=20
	layer.add_child(dialogue_panel)
	var speaker_plate := NinePatchRect.new()
	speaker_plate.position = Vector2(188,475)
	speaker_plate.size = Vector2(278,58)
	speaker_plate.texture=CUTSCENE_NAMEPLATE
	speaker_plate.patch_margin_left=48
	speaker_plate.patch_margin_top=32
	speaker_plate.patch_margin_right=48
	speaker_plate.patch_margin_bottom=32
	speaker_plate.mouse_filter=Control.MOUSE_FILTER_IGNORE
	speaker_plate.z_index = 22
	layer.add_child(speaker_plate)
	var speaker := Label.new()
	speaker.name = "Speaker"
	speaker.position=Vector2(34,10)
	speaker.size=Vector2(210,36)
	...
	portrait_frame.name="MolduraRetrato"
	portrait_frame.position=Vector2(48,465)
	portrait_frame.size=Vector2(176,174)
	portrait_frame.texture=CUTSCENE_PORTRAIT_FRAME
	...
	portrait_frame.z_index=22
	layer.add_child(portrait_frame)
	...
	portrait.position = Vector2(136,555)
	portrait.scale = Vector2(HERO_PORTRAIT_SCALE*0.86,HERO_PORTRAIT_SCALE*0.86)
	portrait.texture_filter = CanvasItem.TEXTURE_FILTER_LINEAR
	portrait.z_index = 23
	layer.add_child(portrait)
	var story := Label.new()
	story.name = "StoryText"
	story.position = Vector2(245,524)
	story.size = Vector2(790,72)
	story.vertical_alignment = VERTICAL_ALIGNMENT_CENTER
	story.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
	...
	var ui_reveal:=create_tween().bind_node(layer)
	ui_reveal.tween_property(top,"modulate:a",1.0,0.32)
	ui_reveal.parallel().tween_property(bottom,"modulate:a",1.0,0.32)
	ui_reveal.tween_property(dialogue_panel,"modulate:a",1.0,0.24)
	...
	for beat in beats:
		...
		portrait_frame.visible=portrait.visible
...
func continue_game() -> void:
	...
	highest_unlocked_level = clampi(int(save.get_value("journey","highest_unlocked",level)),level,levels.size()-1)
	highest_completed_level = clampi(int(save.get_value("journey","highest_completed",level-1)),-1,levels.size()-1)
	load_level()

func has_save() -> bool:
	return FileAccess.file_exists(SAVE_PATH)

func load_menu_progress() -> void:
	if not has_save():
		return
	var save := ConfigFile.new()
	if save.load(SAVE_PATH) != OK:
		return
	var saved_level := clampi(int(save.get_value("journey","level",0)),0,levels.size()-1)
	highest_unlocked_level = clampi(int(save.get_value("journey","highest_unlocked",saved_level)),saved_level,levels.size()-1)
	highest_completed_level = clampi(int(save.get_value("journey","highest_completed",saved_level-1)),-1,levels.size()-1)
...
func save_progress() -> void:
	...
	save.set_value("journey","highest_unlocked",highest_unlocked_level)
	save.set_value("journey","highest_completed",highest_completed_level)
	save.save(SAVE_PATH)
...
func load_level() -> void:
	...
	add_child(world)
	create_parallax()
	# A decoração genérica antiga foi retirada. A identidade agora vem apenas
	# das cenas de parallax e dos TileMaps editáveis de cada família visual.
	create_ambient_life()
...
func show_onboarding_hint() -> void:
	...
	if state!="playing" or level!=0 or not is_instance_valid(player) or not is_instance_valid(world): return
	create_world_tutorial_trigger(Vector2(220,450),Vector2(220,285),"MOVER: A / D  •  ANALÓGICO\nPULAR: %s\nATACAR: %s" % [action_prompt("jump"),action_prompt("attack")],4.2)
	create_world_tutorial_trigger(Vector2(610,450),Vector2(650,285),"GUARDAR: %s\nMOUSE DIREITO também guarda.\nAPARE quando o golpe chegar." % action_prompt("guard"),4.8)
	create_world_tutorial_trigger(Vector2(1080,420),Vector2(1080,265),"ULTIMATE: %s\nUse quando a energia estiver completa." % action_prompt("ultimate"),4.6)

func create_world_tutorial_trigger(trigger_position: Vector2, speech_position: Vector2, message: String, duration: float) -> Area2D:
	var trigger:=Area2D.new()
	trigger.name="TutorialTrigger"
	...
	shape.size=Vector2(150,220)
	collision.shape=shape
	trigger.add_child(collision)
	world.add_child(trigger)
	trigger.body_entered.connect(func(entered: Node2D):
		if entered!=player or not is_instance_valid(trigger): return
		trigger.set_deferred("monitoring",false)
		show_world_tutorial_speech(message,duration,speech_position)
		trigger.queue_free()
	)
	return trigger

func show_world_tutorial_speech(message: String, duration: float, fixed_position: Vector2) -> Node2D:
	for existing in world.find_children("WorldTutorialSpeech","Node2D",true,false):
		if is_instance_valid(existing):
			existing.visible=false
			existing.queue_free()
	var speech:=WORLD_TUTORIAL_SPEECH_SCENE.instantiate() as Node2D
	if not is_instance_valid(world): return speech
	world.add_child(speech)
	var safe_position:=fixed_position
	# A fala nasce fixa no cenário, mas é elevada uma única vez caso o ponto
	# configurado pudesse cobrir o herói no momento da ativação.
	if is_instance_valid(player) and absf(safe_position.x-player.global_position.x)<220.0:
		safe_position.y=minf(safe_position.y,player.global_position.y-205.0)
	safe_position.x=clampf(safe_position.x,180.0,level_width-180.0)
	speech.global_position=safe_position
	speech.call("configure",message,duration)
	return speech
...
func create_parallax() -> void:
	...
	sky.z_index = -20
	world.add_child(sky)
	# Cada fase e seu boss carregam a mesma cena visual editavel.
	var parallax_index := clampi(floori(float(level)/2.0),0,PARALLAX_SCENES.size()-1)
	var packed_parallax := load(PARALLAX_SCENES[parallax_index]) as PackedScene
	if packed_parallax:
		var editable_parallax := packed_parallax.instantiate() as Node2D
		if editable_parallax:
			editable_parallax.name = "Parallax_Editavel"
			world.add_child(editable_parallax)
	var atmosphere := ColorRect.new()
	atmosphere.position = Vector2(-500,-100)
	atmosphere.size = Vector2(level_width+1000,748)
	atmosphere.color = [Color(0.08,0.22,0.05,0.04),Color(0.08,0.22,0.05,0.08),Color(0.10,0.06,0.04,0.08),Color(0.18,0.05,0.02,0.10),Color(0.02,0.08,0.22,0.08),Color(0.02,0.08,0.22,0.12)][level]
...
func create_ambient_life() -> void:
	var count := 8 if not is_boss_level() else 5
	...
	for index in count:
		...
		mote.color = Color(colors[index%colors.size()],0.12+float(index%3)*0.04)
...
func four_seasons_platform_profile() -> Dictionary:
	# Fallback visual para plataformas geradas por codigo. Usa os mesmos atlases
	# 16x16 das cenas editaveis e preserva a identidade de cada fase + boss.
	return [
		{"texture":"tileset_fase_1.png","thin":[Vector2i(0,4),Vector2i(1,4),Vector2i(2,4)],"top":[Vector2i(0,0),Vector2i(1,0),Vector2i(2,0)],"body":[Vector2i(0,2),Vector2i(1,2),Vector2i(2,2)]},
		{"texture":"tileset_fase_1.png","thin":[Vector2i(0,4),Vector2i(1,4),Vector2i(2,4)],"top":[Vector2i(0,0),Vector2i(1,0),Vector2i(2,0)],"body":[Vector2i(0,2),Vector2i(1,2),Vector2i(2,2)]},
		{"texture":"tileset_fase_2.png","thin":[Vector2i(0,4),Vector2i(1,4),Vector2i(2,4)],"top":[Vector2i(0,0),Vector2i(1,0),Vector2i(2,0)],"body":[Vector2i(0,2),Vector2i(1,2),Vector2i(2,2)]},
		{"texture":"tileset_fase_2.png","thin":[Vector2i(0,4),Vector2i(1,4),Vector2i(2,4)],"top":[Vector2i(0,0),Vector2i(1,0),Vector2i(2,0)],"body":[Vector2i(0,2),Vector2i(1,2),Vector2i(2,2)]},
		{"texture":"tileset_fase_3.png","thin":[Vector2i(0,4),Vector2i(1,4),Vector2i(2,4)],"top":[Vector2i(0,0),Vector2i(1,0),Vector2i(2,0)],"body":[Vector2i(0,2),Vector2i(1,2),Vector2i(2,2)]},
		{"texture":"tileset_fase_3.png","thin":[Vector2i(0,4),Vector2i(1,4),Vector2i(2,4)],"top":[Vector2i(0,0),Vector2i(1,0),Vector2i(2,0)],"body":[Vector2i(0,2),Vector2i(1,2),Vector2i(2,2)]}
	][level]
...
func draw_four_seasons_platform(body: StaticBody2D, rect: Vector4, collision_height: float, is_ground: bool) -> void:
	...
	var texture: Texture2D = load(TILESETS_V2_PATH+String(profile.texture))
...
func create_player(pos: Vector2) -> void:
	...
	# Plataformas e chão principal têm recortes visuais diferentes. O ajuste fino
	# de cada superfície permanece editável no Inspector do nó principal.
	player_sprite.position.y = player_platform_feet_offset_y
...
func is_player_on_main_ground_surface() -> bool:
	return is_instance_valid(player) and player.is_on_floor() and player.global_position.y>=main_ground_center_threshold_y

func update_player_visual_feet_alignment() -> void:
	if not is_instance_valid(player_sprite): return
	player_sprite.position.y=player_ground_feet_offset_y if is_player_on_main_ground_surface() else player_platform_feet_offset_y
...
func update_fragment_liquid_fill(_value := 0.0) -> void:
	...
	if inner.x < 2.0:
		inner = Vector2(fragment_bar_host.size.x - 8.0, fragment_bar_host.size.y - 8.0) if is_instance_valid(fragment_bar_host) else Vector2(124, 8)
...
func set_portal_active() -> void:
	...
	portal.set_meta("activation_started_msec",Time.get_ticks_msec())
	portal.visible = true
	...
	if portal_art:
		portal_art.texture=PORTAL_V2_FRAMES[0]
		portal_art.modulate=Color.WHITE
	var portal_effect := portal.get_node_or_null("VisualRoot/PortalActivationEffect") as Sprite2D
	if portal_effect:
		portal_effect.texture=PORTAL_V2_EFFECTS[0]
		portal_effect.visible=true
	...
	reveal.tween_property(portal,"modulate:a",1.0,0.28).set_trans(Tween.TRANS_SINE)
...
func create_portal_activation_fx() -> void:
	...
	# O efeito novo já contém a expansão quadro a quadro; a base fica imóvel no chão.
...
func align_portal_visual_to_ground() -> void:
	if not is_instance_valid(portal): return
	# O Marker2D representa o chão. Além de afundar alguns pixels de folhagem,
	# a posição original fica restaurada a cada quadro para nenhum tween antigo
	# ou ajuste de animação fazer o portal flutuar.
	portal.position.y=float(portal.get_meta("base_y",portal.position.y))
	var visual_root:=portal.get_node_or_null("VisualRoot") as Node2D
	var portal_art:=portal.get_node_or_null("VisualRoot/PortalArt") as Sprite2D
	if not is_instance_valid(visual_root) or not is_instance_valid(portal_art) or portal_art.texture==null: return
	var half_art_height:=portal_art.texture.get_height()*portal_art.scale.y*0.5
	visual_root.position=Vector2(0.0,-half_art_height+portal_ground_overlap)
	visual_root.scale=Vector2.ONE

func apply_portal_effect_frame(effect: Sprite2D, frame_index: int) -> void:
	if not is_instance_valid(effect) or PORTAL_V2_EFFECTS.is_empty(): return
	var safe_index:=clampi(frame_index,0,mini(PORTAL_EFFECT_LAST_STABLE_FRAME,PORTAL_V2_EFFECTS.size()-1))
	var texture:=PORTAL_V2_EFFECTS[safe_index]
	var used_rect:=PORTAL_EFFECT_USED_RECTS[safe_index]
	effect.texture=texture
	# Cada PNG veio recortado em dimensões diferentes. O retângulo visível é
	# compensado para conservar o mesmo centro e o mesmo volume durante a troca.
	var normalized_scale:=Vector2(
		PORTAL_EFFECT_TARGET_VISIBLE_SIZE.x/used_rect.size.x,
		PORTAL_EFFECT_TARGET_VISIBLE_SIZE.y/used_rect.size.y
	)*PORTAL_EFFECT_BASE_SCALE
	var texture_center:=texture.get_size()*0.5
	var visible_center:=used_rect.position+used_rect.size*0.5
	effect.scale=normalized_scale
	effect.position=-(visible_center-texture_center)*normalized_scale
...
func create_portal(pos: Vector2) -> void:
	...
	portal_art.texture = PORTAL_V2_FRAMES[0]
	portal_art.scale = PORTAL_ART_SCALE
	portal_art.position = Vector2(0,0)
	portal_art.texture_filter = CanvasItem.TEXTURE_FILTER_NEAREST
	portal_art.z_index = 2
	visual_root.add_child(portal_art)
	var activation_effect:=Sprite2D.new()
	activation_effect.name="PortalActivationEffect"
	activation_effect.texture=PORTAL_V2_EFFECTS[0]
	activation_effect.scale=Vector2(1.13,1.13)
	activation_effect.texture_filter=CanvasItem.TEXTURE_FILTER_NEAREST
	activation_effect.z_index=3
	activation_effect.visible=false
	visual_root.add_child(activation_effect)
	align_portal_visual_to_ground()
	apply_portal_effect_frame(activation_effect,0)
	...
	for spark_index in 10:
		...
		spark.position=Vector2(-58.0+float((spark_index*31)%117),-70.0+float((spark_index*43)%141))
	...
	label.position = Vector2(-120,-226)
...
func create_hud() -> void:
	hud = GAME_HUD_SCENE.instantiate() as CanvasLayer
	add_child(hud)
	health_label=hud.get_node("%HealthLabel") as Label
	health_bar=hud.get_node("%HealthBar") as ProgressBar
	dash_bar=hud.get_node("%DashBar") as ProgressBar
	guard_bar=hud.get_node("%GuardBar") as ProgressBar
	guard_label=hud.get_node("%GuardLabel") as Label
	ultimate_bar=hud.get_node("%UltimateBar") as ProgressBar
	ultimate_label=hud.get_node("%UltimateLabel") as Label
	ultimate_bar_host=ultimate_bar
	fragment_panel=hud.get_node("%FragmentPanel") as Control
	coin_label=hud.get_node("%CoinLabel") as Label
	fragment_coin_icon=hud.get_node("%FragmentCoinIcon") as TextureRect
	objective_label=hud.get_node("%ObjectiveLabel") as Label
	timer_label=hud.get_node("%TimerLabel") as Label
	difficulty_hud_label=hud.get_node("%DifficultyLabel") as Label
	boss_label=hud.get_node("%BossLabel") as Label
	boss_hud_name=hud.get_node("%BossName") as Label
	boss_hud_bar=hud.get_node("%BossHealthBar") as ProgressBar
	boss_health_value_label=hud.get_node("%BossHealthValue") as Label
	boss_posture_bar=hud.get_node("%BossPostureBar") as ProgressBar
	boss_posture_label=hud.get_node("%BossPostureLabel") as Label
	boss_status_label=hud.get_node("%BossStatusLabel") as Label
	combo_label=hud.get_node("%ComboLabel") as Label
	message_label=hud.get_node("%MessageLabel") as Label
	heart_nodes.clear()
	var hearts_row := hud.get_node("%HeartsRow") as HBoxContainer
	var heart_width := clampf(156.0 / maxf(float(max_health), 1.0), 20.0, 30.0)
	for i in max_health:
		var heart := TextureRect.new()
		heart.custom_minimum_size = Vector2(heart_width,24)
		...
		pulse.tween_property(heart,"scale",Vector2(1.055,1.055),0.32).set_trans(Tween.TRANS_SINE)
		pulse.tween_property(heart,"scale",Vector2.ONE,0.45).set_trans(Tween.TRANS_SINE)
		pulse.tween_interval(1.35)
	health_bar.max_value=max_health
	health_bar.value=health
	dash_bar.max_value=1.0
	guard_bar.max_value=1.0
	ultimate_bar.max_value=1.0
	fragment_coin_icon.visible = false
	var fragment_slot := hud.get_node("%FragmentBarSlot") as HBoxContainer
	fragment_slot.add_child(make_fragment_charge_bar())
	var boss_panel := hud.get_node("%BossPanel") as Control
	boss_panel.visible=is_boss_level()
	fragment_panel.visible=not is_boss_level()
	if is_boss_level():
		var boss_maximum := float(get_boss().get("max_hp",boss_max_health))
		boss_hud_bar.max_value=boss_maximum
		boss_hud_bar.value=boss_maximum
		boss_posture_bar.max_value=100.0
		boss_posture_bar.value=100.0
		var boss_health_slot := hud.get_node("%BossHealthSlot") as HBoxContainer
		boss_health_slot.add_child(make_boss_health_liquid_bar())
	guard_button=null
	var pause_button := hud.get_node("%PauseButton") as TextureButton
...
func make_fragment_charge_bar() -> Control:
	...
	fragment_bar_host.custom_minimum_size = Vector2(132, 14)
...
func make_boss_health_liquid_bar() -> Control:
	boss_health_host = Control.new()
	boss_health_host.custom_minimum_size = Vector2(256,16)
	boss_health_host.clip_contents = false
	boss_health_bg_style = StyleBoxFlat.new()
	boss_health_bg_style.bg_color = Color(0.055,0.012,0.012,0.97)
	boss_health_bg_style.border_color = Color("#d9a64a")
	boss_health_bg_style.set_border_width_all(2)
	boss_health_bg_style.set_corner_radius_all(8)
	boss_health_bg_style.shadow_color = Color(0.72,0.08,0.035,0.42)
	boss_health_bg_style.shadow_size = 4
	var frame := Panel.new()
	frame.set_anchors_and_offsets_preset(Control.PRESET_FULL_RECT)
	frame.mouse_filter = Control.MOUSE_FILTER_IGNORE
	frame.add_theme_stylebox_override("panel",boss_health_bg_style)
	boss_health_host.add_child(frame)
	boss_health_clip = Control.new()
	boss_health_clip.set_anchors_preset(Control.PRESET_FULL_RECT)
	boss_health_clip.offset_left = 4.0
	boss_health_clip.offset_top = 4.0
	boss_health_clip.offset_right = -4.0
	boss_health_clip.offset_bottom = -4.0
	boss_health_clip.clip_contents = true
	boss_health_clip.mouse_filter = Control.MOUSE_FILTER_IGNORE
	boss_health_clip.resized.connect(update_boss_health_liquid_fill)
	boss_health_host.add_child(boss_health_clip)
	var liquid_mat := ShaderMaterial.new()
	liquid_mat.shader = FRAGMENT_LIQUID_SHADER
	liquid_mat.set_shader_parameter("color_deep",Color("#5b0710"))
	liquid_mat.set_shader_parameter("color_mid",Color("#d0272f"))
	liquid_mat.set_shader_parameter("color_surface",Color("#ff6b3d"))
	liquid_mat.set_shader_parameter("color_foam",Color("#ffe5a3"))
	liquid_mat.set_shader_parameter("heat_gold",Color("#ffc65a"))
	liquid_mat.set_shader_parameter("heat",0.14)
	liquid_mat.set_shader_parameter("time_scale",1.35)
	boss_health_liquid = ColorRect.new()
	boss_health_liquid.material = liquid_mat
	boss_health_liquid.color = Color.WHITE
	boss_health_liquid.mouse_filter = Control.MOUSE_FILTER_IGNORE
	boss_health_clip.add_child(boss_health_liquid)
	boss_health_shine = ColorRect.new()
	boss_health_shine.color = Color(1.0,0.91,0.62,0.0)
	boss_health_shine.size = Vector2(18,8)
	boss_health_shine.mouse_filter = Control.MOUSE_FILTER_IGNORE
	boss_health_clip.add_child(boss_health_shine)
	boss_hud_bar.value_changed.connect(update_boss_health_liquid_fill)
	call_deferred("update_boss_health_liquid_fill")
	return boss_health_host

func update_boss_health_liquid_fill(_value := 0.0) -> void:
	if not is_instance_valid(boss_health_liquid) or not is_instance_valid(boss_health_clip) or not is_instance_valid(boss_hud_bar): return
	var ratio := clampf(float(boss_hud_bar.value)/maxf(float(boss_hud_bar.max_value),1.0),0.0,1.0)
	var inner := boss_health_clip.size
	if inner.x < 2.0: inner=Vector2(248,8)
	boss_health_liquid.position=Vector2.ZERO
	boss_health_liquid.size=Vector2(inner.x*ratio,inner.y)

func pulse_boss_health_feedback() -> void:
	if not is_instance_valid(boss_health_host): return
	boss_health_host.modulate=Color("#fff0bf")
	var pulse := create_tween().bind_node(boss_health_host)
	pulse.tween_property(boss_health_host,"modulate",Color.WHITE,0.22).set_trans(Tween.TRANS_QUAD)
	if is_instance_valid(boss_health_shine) and is_instance_valid(boss_health_clip):
		boss_health_shine.position=Vector2(-20,0)
		boss_health_shine.color=Color(1.0,0.91,0.62,0.78)
		var sweep := create_tween().bind_node(boss_health_shine)
		sweep.tween_property(boss_health_shine,"position:x",boss_health_clip.size.x+4.0,0.28).set_trans(Tween.TRANS_QUAD).set_ease(Tween.EASE_OUT)
		sweep.parallel().tween_property(boss_health_shine,"color:a",0.0,0.28)

func update_hud() -> void:
	if not is_instance_valid(health_label): return
	health_label.text = ("VIDA %d/%d" % [int(health),max_health]) if is_equal_approx(health,roundf(health)) else ("VIDA %.1f/%d" % [health,max_health])
	health_bar.value = health
	for i in heart_nodes.size():
		var fraction := clampf(health-float(i),0.0,1.0)
		heart_nodes[i].texture = HUD_HEART_FULL if fraction>=1.0 else (HUD_HEART_HALF if fraction>0.0 else HUD_HEART_EMPTY)
		heart_nodes[i].modulate = Color.WHITE
	coin_label.text = ("ARENA SELADA" if is_boss_level() else "FRAGMENTOS %d/%d" % [coins,total_coins])
	if is_instance_valid(portal_charge_bar):
		portal_charge_bar.value=coins
		update_fragment_liquid_fill()
	objective_label.text = "Derrote %s" % current_boss_short_name() if is_boss_level() and not get_boss().is_empty() else ("Atravesse o portal desperto" if coins == total_coins else "Reúna todos os fragmentos")
	var boss := get_boss()
	boss_label.text = ""
	if is_instance_valid(boss_hud_bar):
		boss_hud_bar.value = 0 if boss.is_empty() else boss.hp
	if is_instance_valid(boss_hud_name):
		boss_hud_name.text = "PORTAL LIBERADO" if boss.is_empty() else current_boss_name()
	if is_instance_valid(boss_health_value_label):
		boss_health_value_label.text = "" if boss.is_empty() else "%d / %d" % [boss.hp,boss.max_hp]
	...
	if is_instance_valid(boss_posture_label):
		boss_posture_label.text="POSTURA QUEBRADA" if not boss.is_empty() and bool(boss.get("posture_broken",false)) else "POSTURA"
...
func _physics_process(delta: float) -> void:
	...
	update_player_visual_feet_alignment()
	if ultimate_active:
		player.velocity = Vector2.ZERO
		player.global_position = ultimate_lock_position
	...
	if is_instance_valid(portal):
		...
		var portal_art := portal.get_node_or_null("VisualRoot/PortalArt") as Sprite2D
		var portal_effect := portal.get_node_or_null("VisualRoot/PortalActivationEffect") as Sprite2D
		if portal.has_meta("active"):
			var started_msec:=int(portal.get_meta("activation_started_msec",Time.get_ticks_msec()))
			var activation_elapsed:=maxf(0.0,float(Time.get_ticks_msec()-started_msec)/1000.0)
			if portal_art:
				var portal_frame:=mini(int(activation_elapsed*12.0),PORTAL_V2_FRAMES.size()-1)
				portal_art.texture=PORTAL_V2_FRAMES[portal_frame]
				portal_art.scale=PORTAL_ART_SCALE
			if portal_effect:
				var raw_effect_frame:=int(activation_elapsed*14.0)
				var effect_frame:=mini(raw_effect_frame,PORTAL_EFFECT_LAST_STABLE_FRAME)
				var fade_start:=float(PORTAL_EFFECT_LAST_STABLE_FRAME+1)/14.0
				var fade_progress:=clampf((activation_elapsed-fade_start)/PORTAL_EFFECT_FADE_DURATION,0.0,1.0)
				portal_effect.visible=fade_progress<1.0
				portal_effect.modulate.a=1.0-fade_progress
				if portal_effect.visible: apply_portal_effect_frame(portal_effect,effect_frame)
		else:
			if portal_art: portal_art.texture=PORTAL_V2_FRAMES[0]
			if portal_effect:
				portal_effect.visible=false
				portal_effect.modulate.a=1.0
...
func ultimate_pose_offset(cell_height: float, extra_x := 0.0) -> Vector2:
	var current_feet_offset := player_sprite.position.y if is_instance_valid(player_sprite) else player_platform_feet_offset_y
	var hero_feet := current_feet_offset + float(HERO_FRAME_SIZE) * 0.5 * HERO_SPRITE_SCALE
...
func animate_player(delta: float, axis: float) -> void:
	...
	anim_time += delta
	var base_feet_offset:=player_ground_feet_offset_y if is_player_on_main_ground_surface() else player_platform_feet_offset_y
	...
	if anim=="jump_attack":
		var jump_frame := clampi(frame,0,HERO_JUMP_ATTACK_FRAMES.size()-1)
		var jump_texture := HERO_JUMP_ATTACK_FRAMES[jump_frame]
		player_sprite.texture=jump_texture
		player_sprite.scale=Vector2(HERO_JUMP_ATTACK_SCALE,HERO_JUMP_ATTACK_SCALE)
		player_sprite.position.x=float(HERO_JUMP_ATTACK_X_OFFSETS[jump_frame])*facing
		var visible_bottom_from_center: float=float(HERO_JUMP_ATTACK_ALPHA_BOTTOMS[jump_frame])-float(jump_texture.get_height())*0.5
		player_sprite.position.y=base_feet_offset+HERO_JUMP_ATTACK_BOTTOM_Y-visible_bottom_from_center*HERO_JUMP_ATTACK_SCALE
		player_sprite.region_rect=Rect2(0,0,jump_texture.get_width(),jump_texture.get_height())
	else:
		player_sprite.texture=hero_textures[anim]
		player_sprite.scale=Vector2(HERO_SPRITE_SCALE,HERO_SPRITE_SCALE)
		player_sprite.position=Vector2(0,base_feet_offset)
	...
	for enemy in enemies:
		...
		if kind == "spore":
			...
			if attack_state == "ranged_windup":
				...
				if enemy.state_time <= 0.0:
					...
					match kind:
						"bramble":
							...
							body.velocity.x=0.0
						"skeleton":
							enemy.state_time=0.24
							body.velocity.x=float(enemy.facing)*135.0
						"sentinel":
							enemy.state_time=0.26
							body.velocity.x=float(enemy.facing)*390.0
						"mushroom":
							enemy.state_time=0.34
							body.velocity.x=float(enemy.facing)*250.0
							body.velocity.y=-220.0
						_:
							enemy.state_time=0.28
							body.velocity.x=float(enemy.facing)*210.0
					create_enemy_lunge_fx(enemy)
					play_enemy_attack_sound(kind)
			elif attack_state == "lunge":
				if kind=="bramble": body.velocity.x=move_toward(body.velocity.x,0.0,1800.0*delta)
				elif kind=="skeleton": body.velocity.x=move_toward(body.velocity.x,0.0,620.0*delta)
				elif kind=="sentinel": body.velocity.x=move_toward(body.velocity.x,float(enemy.facing)*260.0,900.0*delta)
				if enemy.state_time <= 0.0:
					if kind=="mushroom": spawn_spore_landing_puff(body.global_position+Vector2(0,18))
					enemy.attack_state = "recovery"
					enemy.state_time = 0.34 if kind=="bramble" else (0.26 if kind=="skeleton" else (0.30 if kind=="sentinel" else 0.28))
					enemy.cooldown = 1.35
					body.velocity.x = 0.0
			elif attack_state == "recovery":
				...
				enemy.attack_cycle=int(enemy.attack_cycle)+1
				var can_shoot: bool = kind in ["sentinel","bramble","skeleton"] and abs(distance.x)>175.0 and int(enemy.attack_cycle)%2==0
				...
				if absf(desired_direction)>0.1: enemy.facing=desired_direction
				# O cogumelo foi desenhado de frente. Mantê-lo patrulhando de lado produz
				# moonwalk; ele agora guarda posição e se desloca apenas no salto de ataque.
				var target_speed:=0.0 if kind=="mushroom" else desired_direction*(chase_speed if chase else patrol_speed)
				body.velocity.x = move_toward(body.velocity.x,target_speed,520.0*delta)
			...
			if attack_state == "shoot_windup":
				...
				if float(enemy.fx_timer)<=0.0:
					enemy.fx_timer=0.11
					spawn_enemy_attack_fx_v2("flying_trail",body.global_position-Vector2(body.velocity).normalized()*22.0,0.34,0.18,float(enemy.facing)<0.0,128.0,body.velocity.angle()-PI*0.5)
				if enemy.state_time <= 0.0:
					enemy.attack_state = "recovery"
		...
		var attack_reach := float({"bramble":108.0,"skeleton":76.0,"sentinel":72.0,"mushroom":60.0,"flying":62.0}.get(kind,85.0 if is_boss_kind(kind) else 55.0))
		if dangerous and abs(distance.x)<attack_reach and abs(distance.y)<80 and enemy.cooldown<=0.0:
			enemy.cooldown = 0.75
			take_damage(1,false,enemy)
		var desired_animation := "idle"
		if enemy.hurt>0.0:
			desired_animation = "hurt"
		elif attack_state in ["windup","lunge","ranged_windup","shoot_windup","projectile_windup","slam_windup","burrow_windup","collapse_windup","charge_windup","volley_windup","grenade_windup","melee_windup","suppress_windup","ice_windup","ray_windup","peck_windup","zero_windup","anti_air_windup","charge","melee_active","peck_active"]:
			desired_animation = "attack"
		elif absf(body.velocity.x)>10.0:
			desired_animation = "walk"
		if is_boss_kind(kind) and attack_state in ["burrow_windup","collapse_windup","volley_windup","shooting","suppress_windup","suppress_active","ray_windup","ray_active","zero_windup","anti_air_windup"]: desired_animation="special"
		...
		if absf(body.velocity.x)>6.0 and attack_state not in ["windup","ranged_windup","shoot_windup","projectile_windup","slam_windup","burrow_windup","collapse_windup","charge_windup","volley_windup","grenade_windup","melee_windup","suppress_windup","ice_windup","ray_windup","peck_windup","zero_windup","anti_air_windup"]: enemy.facing=signf(body.velocity.x)
...
func update_boss_combat(enemy: Dictionary, body: CharacterBody2D, distance: Vector2, delta: float) -> void:
	var kind := String(enemy.kind)
	enemy.overhead_counter_cooldown=maxf(0.0,float(enemy.get("overhead_counter_cooldown",0.0))-delta)
	...
	var attack_state := String(enemy.attack_state)
	var player_overhead := absf(distance.x)<118.0 and distance.y < -28.0 and distance.y > -195.0
	enemy.overhead_time=clampf(float(enemy.get("overhead_time",0.0))+(delta if player_overhead else -delta*2.5),0.0,0.7)
	if player_overhead and float(enemy.overhead_time)>=0.28 and float(enemy.overhead_counter_cooldown)<=0.0 and attack_state in ["patrol","recovery"]:
		begin_boss_overhead_counter(enemy)
		enemy.overhead_time=0.0
		attack_state=String(enemy.attack_state)
...
func choose_boss_attack(enemy: Dictionary, distance: Vector2) -> void:
	...
	if kind=="badger_boss":
		options=["slam_windup","burrow_windup"]
		if absf(distance.x)>155.0: options.append_array(["charge_windup","charge_windup"])
		else: options.append("slam_windup")
		if phase_two: options.append("collapse_windup")
		if phase_final: options.append_array(["burrow_windup","collapse_windup"])
	elif kind=="cat_boss":
		...
		options=["volley_windup","grenade_windup"]
		if absf(distance.x)<155.0: options.append_array(["melee_windup","melee_windup"])
		else: options.append("volley_windup")
		if phase_two: options.append("suppress_windup")
		if phase_final: options.append_array(["grenade_windup","suppress_windup"])
	else:
		options=["ice_windup","ray_windup"]
		if absf(distance.x)<175.0: options.append_array(["peck_windup","peck_windup"])
		else: options.append("ray_windup")
		if phase_two: options.append("zero_windup")
		if phase_final: options.append_array(["ice_windup","zero_windup"])
	start_selected_boss_attack(enemy,_pick_boss_attack(enemy,options),phase_final)

func _pick_boss_attack(enemy: Dictionary, options: Array[String]) -> String:
	if options.is_empty(): return "slam_windup"
	var last_attack := String(enemy.get("last_attack",""))
	var alternatives: Array[String]=[]
	for option in options:
		if option!=last_attack: alternatives.append(option)
	var pool := alternatives if not alternatives.is_empty() else options
	return pool[rng.randi_range(0,pool.size()-1)]

func start_selected_boss_attack(enemy: Dictionary, state_name: String, phase_final: bool) -> void:
	match state_name:
		"slam_windup": begin_boss_attack(enemy,state_name,0.52,"TREMOR DO COVIL",Color("#b9d36a"),TelegraphType.GROUND_LINE)
		"charge_windup": begin_boss_attack(enemy,state_name,0.34,"INVESTIDA DO ESCAVADOR",Color("#ffd07a"),TelegraphType.CHARGE)
		"burrow_windup": begin_boss_attack(enemy,state_name,0.72,"ROCHAS SUBTERRÂNEAS",Color("#d3a85c"),TelegraphType.GROUND_AREA)
		"collapse_windup": begin_boss_attack(enemy,state_name,0.72 if phase_final else 0.84,"COLAPSO DO COVIL",Color("#8fbf58"),TelegraphType.GROUND_LINE)
		"melee_windup": begin_boss_attack(enemy,state_name,0.34,"CORONHADA",Color("#ffe19a"),TelegraphType.CHARGE)
		"volley_windup": begin_boss_attack(enemy,state_name,0.27,"RAJADA DE METRALHADORA",Color("#ffb35c"),TelegraphType.AIM)
		"grenade_windup": begin_boss_attack(enemy,state_name,0.42,"GRANADA",Color("#ff7845"),TelegraphType.ARC)
		"suppress_windup": begin_boss_attack(enemy,state_name,0.30 if phase_final else 0.34,"FOGO DE SUPRESSÃO",Color("#ff7338"),TelegraphType.AIM)
		"ice_windup": begin_boss_attack(enemy,state_name,0.38,"LANÇAS DE GELO",Color("#8feaff"),TelegraphType.GROUND_AREA)
		"ray_windup": begin_boss_attack(enemy,state_name,0.48,"RAIO GLACIAL",Color("#63cfff"),TelegraphType.AIM)
		"peck_windup": begin_boss_attack(enemy,state_name,0.32,"BICADA CONGELANTE",Color("#d6f8ff"),TelegraphType.CHARGE)
		"zero_windup": begin_boss_attack(enemy,state_name,0.88 if phase_final else 1.05,"ZERO ABSOLUTO",Color("#b0ddff"),TelegraphType.GROUND_AREA)

func begin_boss_overhead_counter(enemy: Dictionary) -> void:
	var kind := String(enemy.kind)
	var title := "RUPTURA VERTICAL"
	var color := Color("#ffd070")
	if kind=="cat_boss": title="TIRO ASCENDENTE"; color=Color("#ff8b52")
	elif kind=="pengu_boss": title="HALO CONGELANTE"; color=Color("#8feaff")
	begin_boss_attack(enemy,"anti_air_windup",0.40,title,color,TelegraphType.RADIAL)

func perform_boss_overhead_counter(enemy: Dictionary) -> void:
	var candidate: Variant=enemy.get("node")
	if not is_instance_valid(candidate) or not is_instance_valid(player): return
	var body: CharacterBody2D=candidate
	var kind := String(enemy.kind)
	var color := Color("#ffd070")
	if kind=="cat_boss": color=Color("#ff8b52")
	elif kind=="pengu_boss": color=Color("#8feaff")
	spawn_sheet_fx(FX_ARC,body.global_position+Vector2(0,-38),22,2 if kind=="pengu_boss" else (0 if kind=="cat_boss" else 3),Vector2(2.25,2.25),0.34)
	create_collect_burst(body.global_position+Vector2(0,-58),0.30,12)
	match kind:
		"badger_boss":
			spawn_dirt_burst(body.global_position+Vector2(0,float(enemy.foot_y)),12)
			create_shockwave(body.global_position)
		"cat_boss":
			var origin := body.global_position+Vector2(0,-62)
			var aim := (player.global_position+player.velocity*0.10-origin).normalized()
			for angle in [-0.20,0.0,0.20]:
				spawn_combat_projectile(enemy,origin,aim.rotated(float(angle))*520.0,"cat_bullet")
			spawn_muzzle_flash(origin,enemy.facing)
		"pengu_boss":
			spawn_penguin_freeze_fx(body.global_position+Vector2(0,-10))
	var delta_to_player := player.global_position-body.global_position
	if absf(delta_to_player.x)<148.0 and delta_to_player.y < 72.0 and delta_to_player.y > -205.0:
		var health_before := health
		take_damage(1.0,false,enemy)
		if kind=="pengu_boss" and health<health_before:
			player_slow_time=maxf(player_slow_time,0.72)
			spawn_penguin_freeze_fx(player.global_position)
	create_floating_text(body.global_position+Vector2(0,-122),"CONTRA-ATAQUE",color)
	enemy.overhead_counter_cooldown=1.35
	enemy.cooldown=0.85
...
func activate_boss_attack(enemy: Dictionary, body: CharacterBody2D, distance: Vector2) -> void:
	...
	match String(enemy.attack_state):
		"anti_air_windup": perform_boss_overhead_counter(enemy); enemy.attack_state="recovery"; enemy.state_time=0.52
...
func spawn_enemy_attack_fx_v2(effect_key: String, pos: Vector2, scale_value: float, duration: float, flip_h := false, anchor_y := 128.0, rotation_value := 0.0) -> Sprite2D:
	var sprite := ENEMY_ATTACK_FX_V2_SCENE.instantiate() as Sprite2D
	if not is_instance_valid(world) or not ATTACK_FX_V2.has(effect_key): return sprite
	sprite.name="AttackFXV2_%s" % effect_key
	world.add_child(sprite)
	sprite.call("configure",ATTACK_FX_V2[effect_key],pos,scale_value,duration,flip_h,anchor_y,rotation_value)
	return sprite

func spawn_projectile_impact_fx_v2(kind: String, pos: Vector2) -> bool:
	match kind:
		"spore_bomb","spore_bomb_armed": spawn_enemy_attack_fx_v2("spore_explosion",pos,0.52,0.31,false)
		"thorn_seed": spawn_enemy_attack_fx_v2("bramble_roots",Vector2(pos.x,540.0),0.55,0.40,false,224.0)
		"bone_shard": spawn_enemy_attack_fx_v2("skeleton_bone",pos,0.40,0.25,false)
		"rune_orb": spawn_enemy_attack_fx_v2("sentinel_shot",pos,0.38,0.24,false)
		"wind_crescent": spawn_enemy_attack_fx_v2("flying_projectile",pos,0.42,0.25,false)
		_: return false
	return true
...
func create_enemy_lunge_fx(enemy: Dictionary) -> void:
	...
	if String(enemy.kind)=="skeleton":
		spawn_enemy_attack_fx_v2("skeleton_slash",body.global_position+Vector2(float(enemy.facing)*38.0,-8.0),0.50,0.25,float(enemy.facing)<0.0)
	elif String(enemy.kind)=="bramble":
		spawn_enemy_attack_fx_v2("bramble_whip",body.global_position+Vector2(float(enemy.facing)*42.0,-6.0),0.52,0.29,float(enemy.facing)<0.0)
	elif String(enemy.kind)=="mushroom":
		spawn_enemy_attack_fx_v2("mushroom_spores",body.global_position+Vector2(float(enemy.facing)*22.0,4.0),0.46,0.28,float(enemy.facing)<0.0)
	elif String(enemy.kind)=="sentinel":
		spawn_enemy_attack_fx_v2("sentinel_thrust",body.global_position+Vector2(float(enemy.facing)*42.0,-10.0),0.48,0.24,float(enemy.facing)<0.0)
...
func spawn_spore_landing_puff(pos: Vector2) -> void:
	if not is_instance_valid(world): return
	spawn_enemy_attack_fx_v2("mushroom_impact",Vector2(pos.x,pos.y+4.0),0.48,0.34,false,224.0)
	for index in 8:
		var mote := Polygon2D.new()
...
func perform_spore_burst(enemy: Dictionary) -> void:
	var body: CharacterBody2D = enemy.node
	spawn_enemy_attack_fx_v2("spore_explosion",body.global_position,0.62,0.34,false)
	var ring := Line2D.new()
	var points := PackedVector2Array()
	for index in 25:
...
func create_delayed_blast(enemy: Dictionary, pos: Vector2, color: Color, radius: float, delay: float, blast_kind: String) -> void:
	...
	timer.timeout.connect(func():
		...
		elif blast_kind=="roots":
			spawn_enemy_attack_fx_v2("bramble_roots",Vector2(pos.x,540.0),0.58,0.42,false,224.0)
...
func create_attack_telegraph(enemy: Dictionary, color: Color) -> void:
	...
	elif (kind=="spore" and state_name=="windup") or state_name=="nova_windup":
		create_typed_telegraph(TelegraphType.RADIAL,enemy,color,candidate.global_position,0.48,96.0)
	elif kind in ["bramble","flying","spore"] and state_name in ["ranged_windup","shoot_windup","projectile_windup"]:
		create_typed_telegraph(TelegraphType.ARC,enemy,color,player.global_position,0.48,0.0)
	elif kind in ["sentinel","skeleton"] and state_name=="ranged_windup":
		create_typed_telegraph(TelegraphType.AIM,enemy,color,player.global_position,0.52,0.0)
	else:
...
func spawn_aimed_projectile(enemy: Dictionary, speed: float, projectile_kind: String) -> void:
	...
	match projectile_kind:
		"bramble": spawn_enemy_attack_fx_v2("bramble_roots",Vector2(candidate.global_position.x,candidate.global_position.y+float(enemy.foot_y)),0.42,0.34,false,224.0)
		"sentinel": spawn_enemy_attack_fx_v2("sentinel_shot",origin,0.34,0.22,float(enemy.facing)<0.0,128.0,direction.angle())
		"flying": spawn_enemy_attack_fx_v2("flying_projectile",origin,0.34,0.20,float(enemy.facing)<0.0,128.0,direction.angle()+PI)
		"skeleton": spawn_enemy_attack_fx_v2("skeleton_bone",origin,0.32,0.20,float(enemy.facing)<0.0,128.0,direction.angle()+PI)
	...
	elif projectile_kind=="skeleton":
		spawn_combat_projectile(enemy,origin,direction*speed,"bone_shard")
	else:
...
func spawn_combat_projectile(enemy: Dictionary, origin: Vector2, velocity: Vector2, projectile_kind: String) -> void:
	...
	var cell: int = int(spec.get("cell",64))
	var start_frame: int = int(spec.get("start_frame",0))
	sprite.region_rect = Rect2(start_frame*cell,row*cell,cell,cell)
	sprite.scale=spec.scale
	sprite.modulate=spec.tint
	sprite.rotation = velocity.angle()+float(spec.get("angle_offset",0.0))
	sprite.texture_filter=CanvasItem.TEXTURE_FILTER_NEAREST if cell==256 else CanvasItem.TEXTURE_FILTER_LINEAR
	...
	projectiles.append({"node":root,"sprite":sprite,"velocity":velocity,"life":float(spec.life),"damage":1.0,"owner":enemy,"radius":float(spec.radius),"kind":projectile_kind,"frames":frames,"row":row,"cell":cell,"start_frame":start_frame,"anim_fps":float(spec.get("anim_fps",18.0)),"clock":0.0,"gravity":float(spec.gravity),"spin":float(spec.spin),"explode_on_ground":bool(spec.explode_on_ground)})

func projectile_definition(kind: String) -> Dictionary:
	var definitions := {
		"thorn_seed":{"texture":FX_PROJECTILE,"row":3,"frames":11,"scale":Vector2(0.55,0.55),"tint":Color("#78c84d"),"radius":19.0,"gravity":520.0,"spin":2.0,"life":3.0,"explode_on_ground":true},
		"wind_crescent":{"texture":ATTACK_FX_V2.flying_projectile,"row":0,"frames":1,"cell":256,"start_frame":2,"scale":Vector2(0.40,0.40),"tint":Color.WHITE,"radius":22.0,"gravity":0.0,"spin":0.0,"angle_offset":PI,"life":2.7,"explode_on_ground":false},
		"rune_orb":{"texture":ATTACK_FX_V2.sentinel_shot,"row":0,"frames":1,"cell":256,"start_frame":1,"scale":Vector2(0.38,0.38),"tint":Color.WHITE,"radius":20.0,"gravity":0.0,"spin":1.4,"life":3.2,"explode_on_ground":false},
		"spore_bomb":{"texture":ATTACK_FX_V2.spore_projectile,"row":0,"frames":1,"cell":256,"start_frame":1,"scale":Vector2(0.36,0.36),"tint":Color.WHITE,"radius":25.0,"gravity":610.0,"spin":1.2,"life":3.2,"explode_on_ground":true},
		"bone_shard":{"texture":ATTACK_FX_V2.skeleton_bone,"row":0,"frames":1,"cell":256,"start_frame":2,"scale":Vector2(0.38,0.38),"tint":Color.WHITE,"radius":20.0,"gravity":0.0,"spin":0.0,"angle_offset":PI,"life":2.7,"explode_on_ground":false},
...
func update_projectiles(delta: float) -> void:
	...
	for projectile in projectiles:
		...
		var cell := int(projectile.get("cell",64))
		var frame := int(projectile.start_frame)+(int(float(projectile.clock)*float(projectile.anim_fps))%int(projectile.frames))
		sprite.region_rect = Rect2(frame*cell,int(projectile.row)*cell,cell,cell)
		...
		if hit_player:
			...
			if not spawn_projectile_impact_fx_v2(String(projectile.kind),root.global_position):
		...
		if bool(projectile.get("explode_on_ground",false)) and root.global_position.y>=535.0:
			if projectile.kind=="spore_bomb":
				...
				continue
			if projectile.kind=="thorn_seed":
				create_delayed_blast(projectile.owner,Vector2(root.global_position.x,540.0),Color("#8fe36d"),72.0,0.42,"roots")
				root.queue_free()
				continue
			create_shockwave(root.global_position)
			if not spawn_projectile_impact_fx_v2(String(projectile.kind),root.global_position+Vector2(0,-8)):
		...
		if projectile.kind=="spore_bomb_armed" and float(projectile.life)<=0.0:
			create_shockwave(root.global_position); spawn_projectile_impact_fx_v2("spore_bomb_armed",root.global_position+Vector2(0,-8))
...
func damage_enemy(enemy: Dictionary, amount: int, knockback: Vector2) -> void:
	...
	if is_boss_kind(enemy.kind) and is_instance_valid(boss_hud_bar):
		boss_hud_bar.value=enemy.hp
		update_boss_health_liquid_fill()
		pulse_boss_health_feedback()
...
func skip_level_developer() -> void:
	...
	highest_completed_level = maxi(highest_completed_level,level)
	level = next_index
	highest_unlocked_level = maxi(highest_unlocked_level,level)
	health = minf(float(max_health),health+1.0)
	save_progress()
	load_level()
...
func show_end(victory: bool) -> void:
	...
	box.add_child(stats)
	var again := make_labeled_action_button("JOGAR NOVAMENTE",320)
	again.name="RetryButton"
	again.pressed.connect(func(): call_deferred("start_game"))
	box.add_child(again)
	var menu := make_labeled_action_button("VOLTAR AO MENU",320)
...
func show_final_credits() -> void:
	...
	var again := make_labeled_action_button("NOVA EXPERIÊNCIA",270,58); again.name="NewExperienceButton"; again.position=Vector2(292,564); again.pressed.connect(func(): call_deferred("show_difficulty_from_end")); layer.add_child(again)
	var menu := make_labeled_action_button("MENU",190,58); menu.name="FinalMenuButton"; menu.position=Vector2(590,564); menu.pressed.connect(func(): call_deferred("show_menu")); layer.add_child(menu)
...
func show_pause() -> void:
	...
	title.add_theme_color_override("font_color",Color("#fff2b2"))
	box.add_child(title)
	var resume := make_labeled_action_button("CONTINUAR")
	resume.name="ResumeButton"
	resume.process_mode = Node.PROCESS_MODE_WHEN_PAUSED
	resume.pressed.connect(resume_game)
	box.add_child(resume)
	var restart := make_labeled_action_button("REINICIAR FASE")
	...
	var quit := make_labeled_action_button("VOLTAR AO MENU")
	quit.name="PauseMenuButton"
